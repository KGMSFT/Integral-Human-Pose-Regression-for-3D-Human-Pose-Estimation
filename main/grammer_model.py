...
class GrammerPoseNet(nn.Module):
    def __init__(self, backbone, head, grammer):
        super(GrammerPoseNet, self).__init__()
...
def get_grammer_net(cfg, is_train, joint_num):
    ...
    grammer = Grammer()
    model = GrammerPoseNet(backbone, head_net, grammer)
    return model
